    ...
    exercises: [
        ...
        },
        {
            ...
            tasks: [
                ...
                {
                    instructionJsx: <p>Save the layout and the tree will visualize with the entire hierarchy. This is a little overwhelming so from the tree configuration menu on the right-hand side, set the <em>depth</em> to <code>1 to initially visualize the first layer only. Set the <em>tree direction</em> to <code>top to bottom</code></code>. Set the <em>color</em> properties to suit your colour scheme.</p>
                },
                {
        ...
        },
        {
            ...
            tasks: [
                ...
                {
                    instructionJsx: <p>Activate the <em>hide screen list</em> option for this capsule. This will ensure that in play mode the users are only able to move between screens using the on-screen navigation objects that you have configured.</p>
                },
                {
